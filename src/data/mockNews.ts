...
export const MOCK_VIDEOS: VideoNewsItem[] = [
  {
    id: 'vid-1',
    title: 'Bhopal: तिरंगा यात्रा का भव्य आयोजन, CM Dr Mohan Yadav शामिल | लाइव रिपोर्ट MP News',
    category: 'मप्र',
    ...
    viewsCount: 52000,
    publishedAt: '2 hours ago',
    author: 'MP Swaraj Bhopal Bureau',
  },
  {
    id: 'vid-2',
    title: 'Indore Metro का भव्य शुभारंभ! CM Dr. Mohan Yadav ने दिखाई हरी झंडी | लाइव MP News',
    category: 'मप्र',
    ...
    viewsCount: 78500,
    publishedAt: '3 hours ago',
    author: 'MP Swaraj Indore Bureau',
  },
  {
    id: 'vid-3',
  ...
  {
    id: 'vid-4',
    title: 'MP के Bittu Tabahi ने अकेले साफ कर दी पूरी नदी! 3 महीने की मेहनत ने बदल दी तस्वीर',
    category: 'मप्र - पर्यावरण',
  ...
  {
    id: 'vid-5',
    title: 'Datia News: हाईवे पर युवक से मारपीट, फिर स्कॉर्पियो में घसीटा; पुलिस ने 6 आरोपियों पर केस दर्ज किया',
    category: 'मप्र - अपराध',
